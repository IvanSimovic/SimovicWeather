...
data class WeatherColors(
    ...
    val heroContentSecondary: Color,
    val heroScrimStart: Color,
    val heroScrimEnd: Color,
    val error: Color,
...
internal val DarkWeatherColors =
    WeatherColors(
        ...
        heroContentSecondary = Color(0xD9FFFFFF),
        heroScrimStart = Color(0x33000000),
        heroScrimEnd = Color(0xB3000000),
